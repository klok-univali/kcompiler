...
public class Parser implements ParserConstants {
  ...
  final public void tipo() throws ParseException {
    ...
    case INTEGER:
      jj_consume_token(INTEGER);
               semantic.Action13(token.image);
      break;
    case REAL:
      jj_consume_token(REAL);
                                                          semantic.Action14(token.image);
      break;
    case STRING:
      jj_consume_token(STRING);
                                                                                                       semantic.Action15(token.image);
      break;
    case LOGIC:
      jj_consume_token(LOGIC);
                                                                                                                                                   semantic.Action16(token.image);
      break;
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
                                                                                                                                                                                                    semantic.Action17(token.image);
      break;
    default:
      jj_la1[14] = jj_gen;
      jj_consume_token(-1);
  ...
  final public void atribuicao() throws ParseException {
    ...
    jj_consume_token(THIS);
                       semantic.Action18(token.image);
    listaDeIdentificadoresDeVariaveis();
    jj_consume_token(AS);
    expressao();
                                                                                                              semantic.Action19(token.image);
    jj_consume_token(DOT);
  }
